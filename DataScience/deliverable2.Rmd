...
* Can you predict a team's record based on their run differential in the first month of the season?
    + If you could predict a team's record based on their run differential in the first month of the season, that would bring significant change to the climate of the first month of the season and I think there would be a difference in the trades occuring before the trade deadline in July.
